...
public class NonTernaryExpr_Regular extends NonTernaryExpr {

    private Term Term;
    private ExprAddopTerms ExprAddopTerms;

    public NonTernaryExpr_Regular (Term Term, ExprAddopTerms ExprAddopTerms) {
        this.Term=Term;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NonTernaryExpr_Regular(\n");
